...
In this section we model our sample process with the Cadenzaflow Modeler.
...
Open Cadenzaflow Modeler and create a new BPMN diagram by Clicking *File > New File > BPMN Diagram*.
...
{{< get-tag repo="cadenzaflow-get-started-javaee" tag="Step-3" >}}
