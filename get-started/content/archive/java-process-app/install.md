...
First, download a distribution of the CadenzaFlow Platform. You can choose from different distributions for various application servers. In this tutorial, we will use the Apache Tomcat based distribution. Download it from [the download page](https://cadenzaflow.com/download#download-other-menu).
