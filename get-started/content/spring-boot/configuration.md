...
menu:
  main:
    ...
    pre: "Configure your CadenzaFlow Spring Boot application"

---

The CadenzaFlow Spring Boot Application created in previous step uses the default and best practice configuration, embedded in a starter. 
...
The full list of supported configuration parameters can be found [here](/manual/latest/user-guide/spring-boot-integration/configuration/#cadenzaflow-engine-properties).
...
You can use "demo/demo", which we configured before, to access the CadenzaFlow web applications.
...
{{< get-tag repo="cadenzaflow-get-started-spring-boot" tag="Step-2" >}}
