---
title: "Security Notices v1.0.1"
weight: 70

menu:
  main:
    name: "Security Notices v1.0.1"
    parent: "security-notices"
    identifier: "notices-v101"
    pre: "Security Notices v1.0.1"
---


# Notices CadenzaFlow v1.0.1
Since CadenzaFlow v1.0.1 is forked from Camudna 7.24 community edition, this section lists related security notices keeping the original notice numbering (from Camunda) the same inherited from Camunda 7.24
